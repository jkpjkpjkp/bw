...
def load_pdf(path: str | Path, con: duckdb.DuckDBPyConnection | None = None) -> str:
    """Load a PDF file and store it directly in DuckDB.
                ...
                if len(pdf.pages) > 20:
                    ...
                    for i in range(0, len(pdf.pages), chunk_size):
                        ...
                        if len(chunk_text) > 500:
                            chapters.append((f"Section {i // chunk_size + 1}", chunk_text))
                else:
                    # Short PDF - single chapter
                    chapters.append(("Content", full_text))
